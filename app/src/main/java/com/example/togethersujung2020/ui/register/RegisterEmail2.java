...
//
//public class RegisterEmail2 extends AppCompatActivity implements View.OnClickListener, Dialog.OnCancelListener {
//
...
//
//        time_counter = (TextView) dialogLayout.findViewById(R.id.emailAuth_time_counter); //없는 아이디를 참조하려고 해서 오류나요!!
